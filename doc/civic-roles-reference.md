...
| [BACKLOG-OPEN.md](BACKLOG-OPEN.md) | `OB-17` … `OB-27` — the open gaps this document identified |
...
Filed in [BACKLOG-OPEN.md](BACKLOG-OPEN.md) as **`OB-17` … `OB-27`**. Nine were fixed on
2026-08-20; that file's status table says what shipped against each.
