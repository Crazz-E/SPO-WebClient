...
Flux, [handoff](ux/handoff/)). Phase 5 : socle-1 → 4 et flux T1, T3, T6, T2, T7, T5, T8, Carte-1/2, feuille flottante, barre mobile fusionnés (PR #55–#70 — tous les lots du plan), canevas alignés (#71), puis les travaux hors plan à partir de la barre de mode mobile (#72) ; suivi dans le brief §6bis ;
