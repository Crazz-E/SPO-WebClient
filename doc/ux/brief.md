...
**Tous les lots du plan sont portés**, et la barre de mode mobile avec (#72). Restent, hors lot : la tablette (panneau ancré) et N5 chat (linkification des coordonnées). N6/N7 et H3 sont fermés (#78), B5 (#79), H6 et N10 (#80) ; N4 serveur et H7 exact sont instruits en tickets RDO (OB-33 / OB-34, hors UI).
