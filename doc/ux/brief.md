...
| #79 | **B5 — rétrogradation confirmée** : « Downgrade » passe par le Dialog socle-2 (`requestConfirm`, kind destructive) dans `upgradeBuildingAction` — l'envoi ne part qu'à la confirmation, comme démolir et les routes ; un niveau payé disparaît sans retour | B5 |
