...
// Miscellaneous
import { handleDefineZone, handleCreateCompany, handleClusterInfo, handleClusterFacilities, handleSearchConnections, handleEmpireFacilities, handleFavoriteAdd, handleFavoriteDelete, handleFavoriteRename, handleFavoriteCreateFolder, handleFavoriteMove, handleResearchInventory, handleResearchDetails } from './misc-handlers';
...
export const wsHandlerRegistry: Partial<Record<WsMessageType, WsHandler>> = {
  ...
  [WsMessageType.REQ_FAVORITE_CREATE_FOLDER]: handleFavoriteCreateFolder,
