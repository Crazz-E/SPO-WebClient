...
// Miscellaneous
import { handleDefineZone, handleCreateCompany, handleClusterInfo, handleClusterFacilities, handleSearchConnections, handleEmpireFacilities, handleFavoriteAdd, handleFavoriteDelete, handleFavoriteRename, handleFavoritesFolder, handleFavoriteAddFolder, handleResearchInventory, handleResearchDetails } from './misc-handlers';
...
export const wsHandlerRegistry: Partial<Record<WsMessageType, WsHandler>> = {
  ...
  [WsMessageType.REQ_FAVORITES_FOLDER]: handleFavoritesFolder,
  [WsMessageType.REQ_FAVORITE_ADD_FOLDER]: handleFavoriteAddFolder,
