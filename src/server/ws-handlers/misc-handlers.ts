...
export const handleFavoriteCreateFolder: WsHandler = async (ctx: WsHandlerContext, msg: WsMessage): Promise<void> => {
  await withErrorHandler(ctx.ws, msg.wsRequestId, ErrorCodes.ERROR_Unknown, async () => {
    const req = msg as WsReqFavoriteCreateFolder;
    ...
    const response: WsRespFavoriteCreateFolder = {
