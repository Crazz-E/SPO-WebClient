 ...
 *
 * A tax account (`Obj.AccountIsTax`, :167/:179) carries two extra cells in the
 * same `<tr>` — Town/IFEL captions on the level-2 header, split figures on the
 * rows beneath — read by `taxOf` without disturbing `rowRegex` or `flushRegex`.
 */
