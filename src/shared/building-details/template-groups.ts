  ...
  properties: [
    { rdoName: 'ActualRuler', displayName: 'Ruler', type: PropertyType.TEXT },
    {
      ...
      columns: [
        ...
        { rdoSuffix: 'Ministry', label: 'Ministry', type: PropertyType.TEXT, width: '18%', indexSuffix: '.0' },
        { rdoSuffix: 'Minister', label: 'Minister', type: PropertyType.TEXT, width: '16%' },
        { rdoSuffix: 'MinisterRating', label: 'Rating', type: PropertyType.PERCENTAGE, width: '14%' },
        { rdoSuffix: 'MinisterBudget', label: 'Budget', type: PropertyType.CURRENCY, width: '20%', editable: true },
        { rdoSuffix: 'electMinister', label: '', type: PropertyType.ACTION_BUTTON, width: '10%', actionId: 'electMinister', buttonLabel: 'Elect' },
        { rdoSuffix: 'deposeMinister', label: '', type: PropertyType.ACTION_BUTTON, width: '12%', actionId: 'deposeMinister', buttonLabel: 'Depose' },
      ],
    },
  ],
  rdoCommands: {
