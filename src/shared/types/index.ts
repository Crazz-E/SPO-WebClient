...
export type { ConnectionSearchResult, FavoritesItem, FavoriteFolder, ResearchCategoryData, ResearchInventionItem, ResearchInventionDetails } from './message-types';
